...
public class CT1_PiecePosition : MonoBehaviour
{
    CT1_LevelManager levelManager;
    public GameObject player;
    public GameObject boxManager;
    private CT1_PlayerController playerScript;
    private CT1_BoxManager boxManagerScript;
    private List<GameObject> boxes;
    // Start is called before the first frame update
    void Start()
    {
        levelManager = GameObject.Find("LevelManager").GetComponent<CT1_LevelManager>();
        playerScript = player.GetComponent<CT1_PlayerController>();
        boxManagerScript = boxManager.GetComponent<CT1_BoxManager>();
    ...
    public void addBoxPos(string lastMove)
    {
        foreach(GameObject box in boxes){
            CT1_BoxController tempController=box.GetComponent<CT1_BoxController>();
